...
urlpatterns = [
    ...
    path('',views.homee, name='homee-page'),
    ...
    path('studentregisterdata',views.studentregisterdata,name='studentregister-data'),
    path('studentloginaction',views.studentloginaction,name='studentlogin-action'),
    ...
    path('messages_box',views.messages_box, name='messages-box'),
    path('available__books',views.available__books, name='available_books')
