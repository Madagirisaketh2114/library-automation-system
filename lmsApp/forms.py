...
class studentregisterforms(forms.ModelForm):
    ...
    student_phone = forms.CharField(max_length=12)
    mail_id = forms.CharField(max_length=250)
    password = forms.CharField(max_length=20)

    class Meta:
        model = models.studentregistermodels
        fields = ('student_id', 'student_name', 'student_phone', 'mail_id','password' )
